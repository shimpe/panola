...
duration decomposition; explicit teletype::*m/d:: tuplets are still emitted atomically. Eighths-and-shorter
...
PanolaMEI {
	...
	description = "render several Panola voices as one multi-staff MEI score (one voice per staff, top first), including meter-aware splitting-and-tying at metrical boundaries, per-beat beaming, tuplets, per-note dynamics/articulation, and slurs."
